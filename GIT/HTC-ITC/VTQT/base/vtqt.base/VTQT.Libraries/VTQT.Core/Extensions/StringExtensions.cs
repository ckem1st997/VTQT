...
namespace VTQT
{
    public static class StringExtensions
    {
        ...
        // TODO-XBase-Culture: Remove CultureInfo.CurrentUICulture for Microservices, Add CultureInfo by LanguageId/Code
        ...
        public static string JavaScriptStringEncode(this LocalizedString value)
        {
            return JavaScriptStringEncode(value.Text);
        }
