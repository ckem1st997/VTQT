...
namespace VTQT.Core.Infrastructure
{
    /// <summary>
    ...
    public class XBaseEngine : IEngine
    {
        ...
        public virtual void RegisterDependencies(ContainerBuilder containerBuilder, XBaseConfig config)
        {
            //register engine
        ...
        /// <param name="config">Nop configuration parameters</param>
        public void ConfigureServices(IServiceCollection services, IConfiguration configuration, XBaseConfig config)
        {
            //find startup configurations provided by other assemblies
            _typeFinder = new WebAppTypeFinder();
            var startupConfigurations = _typeFinder.FindClassesOfType<IXBaseStartup>();

            //create and sort instances of startup configurations
            var instances = startupConfigurations
                .Select(startup => (IXBaseStartup)Activator.CreateInstance(startup))
        ...
        public void ConfigureRequestPipeline(IApplicationBuilder application, IConfiguration configuration)
        {
            ...
            var startupConfigurations = typeFinder.FindClassesOfType<IXBaseStartup>();
        ...
        public virtual object ResolveUnregistered(Type type)
        {
            ...
            foreach (var constructor in type.GetConstructors())
            {
                try
                {
                    ...
                    var parameters = constructor.GetParameters().Select(parameter =>
                    {
                        ...
                        if (service == null)
                            throw new XBaseException("Unknown dependency");
                        return service;
                    });
            ...
            throw new XBaseException("No constructor was found that had all the dependencies satisfied.", innerException);
        }
