...
namespace VTQT.Core.Infrastructure
{
    ...
    public interface IEngine
    {
        ...
        void ConfigureServices(IServiceCollection services, IConfiguration configuration, XBaseConfig config);
        ...
        /// <param name="config">Nop configuration parameters</param>
        void RegisterDependencies(ContainerBuilder containerBuilder, XBaseConfig config);
