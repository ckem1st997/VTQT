...
namespace VTQT.Services.Seo
{
    ...
    public partial interface IUrlRecordService
    {
        ...
        /// </returns>
        Task<IList<UrlRecord>> GetUrlRecordsByIdsAsync(string[] urlRecordIds);
        ...
        /// </returns>
        Task<IPagedList<UrlRecord>> GetAllUrlRecordsAsync(string slug = "", string languageId = null, bool? isActive = null, int pageIndex = 0, int pageSize = int.MaxValue);
        ...
        /// </returns>
        Task<string> GetActiveSlugAsync(string entityId, string entityName, string languageId);
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        Task SaveSlugAsync<T>(T entity, string slug, string languageId) where T : BaseEntity, ISlugSupported;
        ...
        /// </returns>
        Task<string> GetSeNameAsync<T>(T entity, string languageId = null, bool returnDefaultValue = true,
        ...
        /// The task result contains the search engine  name (slug)
        /// </returns>
        Task<string> GetSeNameAsync(string entityId, string entityName, string languageId = null,
        ...
        /// The task result contains the valid sename
        /// </returns>
        Task<string> ValidateSeNameAsync(string entityId, string entityName, string seName, string name, bool ensureNotEmpty);
    }
}
