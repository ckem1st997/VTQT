...
namespace VTQT.Services.Localization
{
    ...
    public partial interface ILocalizationService
    {
        ...
        /// </returns>
        Task<LocaleStringResource> GetLocaleStringResourceByIdAsync(string localeStringResourceId);
        ...
        /// The task result contains the locale string resource
        /// </returns>
        Task<LocaleStringResource> GetLocaleStringResourceByNameAsync(string resourceName, string languageId,
        ...
        /// </returns>
        Task<Dictionary<string, KeyValuePair<string, string>>> GetAllResourceValuesAsync(string languageId);
        ...
        /// The task result contains a string representing the requested resource string.
        /// </returns>
        Task<string> GetResourceAsync(string resourceKey, string languageId = SettingDefaults.AllLanguagesId,
        ...
        /// The task result contains a string representing the requested resource string.
        /// </returns>
        string GetResource(string resourceKey, string languageId = SettingDefaults.AllLanguagesId,
            bool logIfNotFound = true, string defaultValue = "", bool returnEmptyIfNotFound = false);
        ...
        /// </returns>
        Task<string> GetLocalizedEnumAsync<TEnum>(TEnum enumValue, string languageId = null) where TEnum : struct;
        ...
        /// The task result contains the localized value
        /// </returns>
        string GetLocalizedEnum<TEnum>(TEnum enumValue, string languageId = null) where TEnum : struct;
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        Task AddLocaleResourceAsync(IDictionary<string, string> resources, string languageId = null);
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        Task DeleteLocaleResourcesAsync(IList<string> resourceNames, string languageId = null);
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        Task DeleteLocaleResourcesAsync(string resourceNamePrefix, string languageId = null);
    }
}
