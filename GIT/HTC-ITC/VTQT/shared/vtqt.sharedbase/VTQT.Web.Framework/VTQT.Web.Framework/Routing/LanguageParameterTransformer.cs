...
namespace VTQT.Web.Framework.Routing
{
    ...
    public class LanguageParameterTransformer : IOutboundParameterTransformer
    {
        ...
        public string TransformOutbound(object value)
        {
            ...
            if (routeValues.TryGetValue(XBasePathRouteDefaults.LanguageRouteValue, out var routeValue))
            {
                ...
                var languages = _languageService.GetAllLanguagesAsync(appId: app.Id).Result;
            ...
            var currentLanguage = workContext.WorkingLanguage;
