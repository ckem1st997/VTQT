...
namespace VTQT.Web.Framework.UI
{
    ...
    {
        public TabStripBuilder(TabStrip Component, IHtmlHelper htmlHelper)
        ...
        public TabStripBuilder XBaseTabSelection(bool value)
        {
            base.Component.XBaseTabSelection = value;
            return this;
        }
