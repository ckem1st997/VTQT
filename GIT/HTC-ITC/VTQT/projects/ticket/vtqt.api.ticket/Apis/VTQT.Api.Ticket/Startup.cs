...
namespace VTQT.Api.Ticket
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddXBaseSwagger("v1", "VTQT Ticket API", "VTQT.Api.Ticket.xml");
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseXBaseSwagger("/swagger/v1/swagger.json", "VTQT Ticket API");
        }
    }
}
