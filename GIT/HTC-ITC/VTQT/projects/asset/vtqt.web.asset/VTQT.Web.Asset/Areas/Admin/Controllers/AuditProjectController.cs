...
{
    [XBaseMvcAuthorize]
    public class AuditProjectController : AdminMvcController
    {
        #region Fields
        ...
        public AuditProjectController(IWorkContext workContext)
        {
        ...
        {
            var res = await ApiHelper.ExecuteAsync<AuditModel>("/audit-project/details", new { id = id }, Method.GET, ApiHosts.Asset);

            var projects = ApiHelper.Execute<List<ProjectModel>>("/project/get-available", null, Method.GET, ApiHosts.Master);
            ...
            foreach (var item in projects.data)
            {
                ...
                model.AvailableProjects.Add(tem);
            }
            return View(model);
        }
        ...
        {
            var res = await ApiHelper.ExecuteAsync<AuditModel>("/audit-project/create", null, Method.GET, ApiHosts.Asset);
        ...
        public async Task<IActionResult> CreateSave(AuditModel model, IEnumerable<AuditDetailModel> modelDetails, IEnumerable<AuditCouncilModel> auditCouncilModels)
        {
            ...
            var res = await ApiHelper.ExecuteAsync("/audit-project/create", model, Method.POST, ApiHosts.Asset);
            if (!res.success)
            {
        ...
        {
            var res = await ApiHelper.ExecuteAsync<AuditModel>("/audit-project/edit", new { id = id }, Method.GET, ApiHosts.Asset);
            var projects = ApiHelper.Execute<List<ProjectModel>>("/project/get-available", null, Method.GET, ApiHosts.Master);
        ...
        {
            model.AssetType = (int)AssetType.Project;
            var res = await ApiHelper.ExecuteAsync("/audit-project/edit", model, Method.POST, ApiHosts.Asset);
            if (!res.success)
            {
                NotifyError(res.GetErrorsToHtml());
                return Ok(new XBaseResult { success = false });
        ...
        public async Task<IActionResult> Deletes(IEnumerable<string> ids)
        {
            ...
            var res = await ApiHelper.ExecuteAsync("/audit-project/deletes", ids, Method.POST, ApiHosts.Asset);
            if (!res.success)
            {
                NotifyError(res.GetErrorsToHtml());
                return Ok(new XBaseResult { success = false });
        ...
        {
            var res = await ApiHelper.ExecuteAsync<AuditDetailModel>("/audit-detail-project/detail-create", null, Method.GET, ApiHosts.Asset);
        ...
        {
            var res = await ApiHelper.ExecuteAsync("/audit-detail-project/detail-create", model, Method.POST, ApiHosts.Asset);
            if (!res.success)
            {
                NotifyError(res.GetErrorsToHtml());
                return Ok(new XBaseResult { success = false });
        ...
        {
            var res = await ApiHelper.ExecuteAsync<AuditDetailModel>("/audit-detail-project/detail-edit", new { id = id }, Method.GET, ApiHosts.Asset);
        ...
        {
            var res = await ApiHelper.ExecuteAsync("/audit-detail-project/detail-edit", model, Method.POST, ApiHosts.Asset);
            if (!res.success)
            {
                NotifyError(res.GetErrorsToHtml());
                return Ok(new XBaseResult { success = false });
        ...
        public async Task<IActionResult> DeleteItems(IEnumerable<string> ids)
        {
            ...
            var res = await ApiHelper.ExecuteAsync("/audit-detail-project/detail-deletes", ids, Method.POST, ApiHosts.Asset);
            if (!res.success)
            {
                NotifyError(res.GetErrorsToHtml());
                return Ok(new XBaseResult { success = false });
        ...
        public async Task<IActionResult> EditListItem([Bind(Prefix = "models")] IEnumerable<AuditDetailModel> models)
        {
            ...
            var res = await ApiHelper.ExecuteAsync("/audit-detail-project/detail-edit-list", models, Method.POST, ApiHosts.Asset);
            if (!res.success)
            {
                NotifyError(res.GetErrorsToHtml());
                return Ok(new XBaseResult { success = false });
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var resLastSelected = await ApiHelper.
               ExecuteAsync<string>($"/organization/get-last-selected/?appId=6&userId={_workContext.UserId}&path=/Admin/AuditProject", null, Method.GET, ApiHosts.Master);
        ...
        public async Task<ActionResult> Read([DataSourceRequest] DataSourceRequest request, AuditSearchModel searchModel)
        {
            ...
            var res = await ApiHelper.ExecuteAsync<List<AuditModel>>("/audit-project/get-list-name", searchModel, Method.GET, ApiHosts.Asset);
            var data = res.data;
            if (!string.IsNullOrEmpty(searchModel.OrganizationId))
            {
                var resLastSelected = await ApiHelper
                    .ExecuteAsync<string>($"/organization/update-last-selected/?appId=6&userId={_workContext.UserId}&path=/Admin/AuditProject&departmentId={searchModel.OrganizationId}", null, Method.POST, ApiHosts.Master);
            }

            if (data?.Count > 0)
            {
                var listUser = await ApiHelper.ExecuteAsync<AuditModel>("/audit-project/create", null, Method.GET, ApiHosts.Asset);
        ...
        {
            var res = await ApiHelper.ExecuteAsync<List<AuditDetailModel>>("/audit-detail-project/detail-get", searchModel, Method.GET, ApiHosts.Asset);
            var result = new DataSourceResult();
            if (res.data == null)
            {
                return Ok(result);
        ...
        {
            var res = await ApiHelper.ExecuteAsync<List<AssetModel>>($"/audit-detail-project/get-bt-projectCodeId?idProjectCode={id}&dateTime={dateTime}%2023%3A59%3A59&assetType=30",null, Method.GET, ApiHosts.Asset);
            var data = res.data;
            if (data != null)
            {
        ...
        {
            var res = await ApiHelper.ExecuteAsync<List<AuditCouncilModel>>("/audit-council-project/get", searchModel, Method.GET, ApiHosts.Asset);
            var data = res.data;
        ...
        {
            var res = await ApiHelper.ExecuteAsync<AuditCouncilModel>("audit-council-project/create", null, Method.GET, ApiHosts.Asset);
        ...
        public async Task<IActionResult> CreateAuditCouncil(AuditCouncilModel model)
        {
            ...
            var res = await ApiHelper.ExecuteAsync("/audit-council-project/create", model, Method.POST, ApiHosts.Asset);
            if (!res.success)
            {
                NotifyError(res.GetErrorsToHtml());
                return Ok(new XBaseResult { success = false });
        ...
        {
            var res = await ApiHelper.ExecuteAsync<AuditCouncilModel>("/audit-council-project/edit", new { id = id }, Method.GET, ApiHosts.Asset);
        ...
        {
            model.EmployeeName = "trung";
            var res = await ApiHelper.ExecuteAsync("/audit-council-project/edit", model, Method.POST, ApiHosts.Asset);
            if (!res.success)
            {
                NotifyError(res.GetErrorsToHtml());
                return Ok(new XBaseResult { success = false });
        ...
        public async Task<IActionResult> DeleteAuditCouncil(IEnumerable<string> ids)
        {
            ...
            var res = await ApiHelper.ExecuteAsync("/audit-council-project/deletes", ids, Method.POST, ApiHosts.Asset);
            if (!res.success)
            {
                NotifyError(res.GetErrorsToHtml());
                return Ok(new XBaseResult { success = false });
        ...
        {
            var fileName = "danh-sach-kiem-ke-tai-san-du-an.xlsx";
            var res = await ApiHelper.ExecuteAsync<List<AuditModel>>("/audit-project/get-list-name", model, Method.GET, ApiHosts.Asset);
            ...
            var ws = pck.Workbook.Worksheets.Add("Danh sách kiểm kê TS dự án");
            ...
            {
                rng.Value = "Danh sách kiểm kê tài sản dự án";
                rng.Merge = true;
        ...
        {
            model.AssetType = AssetType.Project;
            var res = await ApiHelper.ExecuteAsync<List<AuditModel>>("/audit-project/get-list-name", model, Method.GET, ApiHosts.Asset);
            var projects = ApiHelper.Execute<List<ProjectModel>>("/project/get-available", null, Method.GET, ApiHosts.Master);
            var data = res?.data;
            var orders1 = projects.data;
            var stt = 1;
            ...
            infoRow["Title"] = "Báo cáo kiểm kê tài sản dự án";
            ...
            var tmpPath = CommonHelper.MapPath("/wwwroot/Teamplate/Excel/AuditProject_vi.xlsx");
            ...
            var fileDownloadName = "bao_cao_kiem_ke_tai_san_du_an.xlsx";
        ...
        public virtual async Task<IActionResult> ImportExcel(IEnumerable<AuditModel> models)
        {
            ...
            foreach (var item in models)
            {
                ...
                teamCreate.Add(item);
                countColumn++;
                var res = await ApiHelper.ExecuteAsync("/audit-project/create", item, Method.POST, ApiHosts.Asset);
        ...
        {
            var fileName = "danh-sach-kiem-ke-du-an.xlsx";
            ExcelPackage.LicenseContext = OfficeOpenXml.LicenseContext.NonCommercial;
            using var pck = new ExcelPackage();
            //Create the worksheet
            var ws = pck.Workbook.Worksheets.Add("Danh sách kiểm kê TS dự án");
        ...
        public async Task<byte[]> GetExcelReportError(Dictionary<int, string> model)
        {
            ...
            dtInfo.Columns.Add("Title", typeof(string));
            var infoRow = dtInfo.NewRow();
            infoRow["Title"] = "Danh sách nhập lỗi kiểm kê dự án";
            dtInfo.Rows.Add(infoRow);
            ds.Tables.Add(dtInfo);
            ...
            dtData.TableName = dtDataName;
            ds.Tables.Add(dtData);
            var tmpPath = CommonHelper.MapPath("/wwwroot/ImportExcel/err-auditProject.xlsx");
            var wb = new Workbook(tmpPath);
            var wd = new WorkbookDesigner(wb);
            wd.SetDataSource(dataSet: ds);
            wd.Process();
        ...
        {
            var res = ApiHelper.Execute<List<ProjectModel>>("/project/get-available", null, Method.GET, ApiHosts.Master);
        ...
        public async Task<ActionResult> ExportDone(string? id)
        {
            ...
            var entity = res.data;
            var result = await ApiHelper.ExecuteAsync<List<AuditDetailModel>>($"/audit-detail-project/detail-get?AuditId={id}", null, Method.GET, ApiHosts.Asset);
            var result1 = await ApiHelper.ExecuteAsync<List<AuditCouncilModel>>($"/audit-council-project/get?AuditId={id}", null, Method.GET, ApiHosts.Asset);
            var projects = ApiHelper.Execute<List<ProjectModel>>("/project/get-available", null, Method.GET, ApiHosts.Master);
            var orders1 = projects.data;
            ...
            var tmpPath = CommonHelper.MapPath("/wwwroot/Teamplate/Excel/bienbankiemkeduan.xls");
            var wb = new Workbook(tmpPath);
            var wd = new WorkbookDesigner(wb);
            wd.SetDataSource(dataSet: ds);
            wd.Process();
