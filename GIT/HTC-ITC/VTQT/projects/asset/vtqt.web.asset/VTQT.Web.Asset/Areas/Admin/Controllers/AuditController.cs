...
namespace VTQT.Web.Asset.Areas.Admin.Controllers
{
    ...
    public class AuditController : AdminMvcController
    {
        ...
        {
            var res = await ApiHelper.ExecuteAsync<AuditModel>("/audit/details", new { id = id }, Method.GET, ApiHosts.Asset);
            ...
            foreach (var item in organizations.data)
            {
                ...
                model.AvailableOrganizations.Add(tem);
            }
            return View(model);
        }

        public async Task<IActionResult> Create(string IdOrganization)
        {
            var res = await ApiHelper.ExecuteAsync<AuditModel>("/audit/create", null, Method.GET, ApiHosts.Asset);
            ...
            if (!string.IsNullOrEmpty(IdOrganization))
                model.AuditLocation = IdOrganization;
        ...
        public async Task<IActionResult> CreateSave(AuditModel model, IEnumerable<AuditDetailModel> modelDetails, IEnumerable<AuditCouncilModel> auditCouncilModels)
        {
            ...
            var res = await ApiHelper.ExecuteAsync("/audit/create", model, Method.POST, ApiHosts.Asset);
            if (!res.success)
            {
        ...
        {
            var res = await ApiHelper.ExecuteAsync<AuditModel>("/audit/edit", new { id = id }, Method.GET, ApiHosts.Asset);
            var organizations = ApiHelper.Execute<List<OrganizationModel>>("/organization/get-available", null, Method.GET, ApiHosts.Master);
        ...
        {
            model.AssetType = (int)AssetType.Office;
            var res = await ApiHelper.ExecuteAsync("/audit/edit", model, Method.POST, ApiHosts.Asset);
            if (!res.success)
            {
                NotifyError(res.GetErrorsToHtml());
                return Ok(new XBaseResult { success = false });
        ...
        public async Task<IActionResult> Deletes(IEnumerable<string> ids)
        {
            ...
            var res = await ApiHelper.ExecuteAsync("/audit/deletes", ids, Method.POST, ApiHosts.Asset);
            if (!res.success)
            {
                NotifyError(res.GetErrorsToHtml());
                return Ok(new XBaseResult { success = false });
        ...
        {
            var res = await ApiHelper.ExecuteAsync<AuditDetailModel>("/audit-detail/detail-create", null, Method.GET, ApiHosts.Asset);
        ...
        {
            var res = await ApiHelper.ExecuteAsync("/audit-detail/detail-create", model, Method.POST, ApiHosts.Asset);
            if (!res.success)
            {
                NotifyError(res.GetErrorsToHtml());
                return Ok(new XBaseResult { success = false });
        ...
        {
            var res = await ApiHelper.ExecuteAsync<AuditDetailModel>("/audit-detail/detail-edit", new { id = id }, Method.GET, ApiHosts.Asset);
        ...
        {
            var res = await ApiHelper.ExecuteAsync("/audit-detail/detail-edit", model, Method.POST, ApiHosts.Asset);
            if (!res.success)
            {
                NotifyError(res.GetErrorsToHtml());
                return Ok(new XBaseResult { success = false });
        ...
        public async Task<IActionResult> DeleteItems(IEnumerable<string> ids)
        {
            ...
            var res = await ApiHelper.ExecuteAsync("/audit-detail/detail-deletes", ids, Method.POST, ApiHosts.Asset);
            if (!res.success)
            {
                NotifyError(res.GetErrorsToHtml());
                return Ok(new XBaseResult { success = false });
        ...
        public async Task<IActionResult> EditListItem([Bind(Prefix = "models")] IEnumerable<AuditDetailModel> models)
        {
            ...
            var res = await ApiHelper.ExecuteAsync("/audit-detail/detail-edit-list", models, Method.POST, ApiHosts.Asset);
            if (!res.success)
            {
                NotifyError(res.GetErrorsToHtml());
                return Ok(new XBaseResult { success = false });
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var resLastSelected = await ApiHelper.
               ExecuteAsync<string>($"/organization/get-last-selected/?appId=6&userId={_workContext.UserId}&path=/Admin/Audit", null, Method.GET, ApiHosts.Master);
        ...
        public async Task<ActionResult> Read([DataSourceRequest] DataSourceRequest request, AuditSearchModel searchModel)
        {
            ...
            var res = await ApiHelper.ExecuteAsync<List<AuditModel>>("/audit/get-list-name", searchModel, Method.GET, ApiHosts.Asset);
            var data = res.data;
            if (!string.IsNullOrEmpty(searchModel.OrganizationId))
            {
                var resLastSelected = await ApiHelper
                    .ExecuteAsync<string>($"/organization/update-last-selected/?appId=6&userId={_workContext.UserId}&path=/Admin/Audit&departmentId={searchModel.OrganizationId}", null, Method.POST, ApiHosts.Master);
            }

            if (data?.Count > 0)
            {
                var listUser = await ApiHelper.ExecuteAsync<AuditModel>("/audit/create", null, Method.GET, ApiHosts.Asset);
        ...
        {
            var res = await ApiHelper.ExecuteAsync<List<AuditDetailModel>>("/audit-detail/detail-get", searchModel, Method.GET, ApiHosts.Asset);
            var result = new DataSourceResult();
            if (res.data == null)
            {
                return Ok(result);
        ...
        {
            var res = await ApiHelper.ExecuteAsync<List<AssetModel>>($"/audit-detail/get-bt-organizationUnitId?idOrganization={id}&dateTime={dateTime}%2023%3A59%3A59&assetType=10", null, Method.GET, ApiHosts.Asset);
            var data = res.data;
            if (data != null)
            {
        ...
        {
            var res = await ApiHelper.ExecuteAsync<List<AuditCouncilModel>>("/audit-council/get", searchModel, Method.GET, ApiHosts.Asset);
            var data = res.data;
        ...
        {
            var res = await ApiHelper.ExecuteAsync<AuditCouncilModel>("audit-council/create", null, Method.GET, ApiHosts.Asset);
        ...
        public async Task<IActionResult> CreateAuditCouncil(AuditCouncilModel model)
        {
            ...
            var res = await ApiHelper.ExecuteAsync("/audit-council/create", model, Method.POST, ApiHosts.Asset);
            if (!res.success)
            {
                NotifyError(res.GetErrorsToHtml());
                return Ok(new XBaseResult { success = false });
        ...
        {
            var res = await ApiHelper.ExecuteAsync<AuditCouncilModel>("/audit-council/edit", new { id = id }, Method.GET, ApiHosts.Asset);
        ...
        {
            model.EmployeeName = "trung";
            var res = await ApiHelper.ExecuteAsync("/audit-council/edit", model, Method.POST, ApiHosts.Asset);
            if (!res.success)
            {
                NotifyError(res.GetErrorsToHtml());
                return Ok(new XBaseResult { success = false });
        ...
        public async Task<IActionResult> DeleteAuditCouncil(IEnumerable<string> ids)
        {
            ...
            var res = await ApiHelper.ExecuteAsync("/audit-council/deletes", ids, Method.POST, ApiHosts.Asset);
            if (!res.success)
            {
                NotifyError(res.GetErrorsToHtml());
                return Ok(new XBaseResult { success = false });
        ...
        public async Task<ActionResult> ExportOrder(AuditSearchModel model)
        {
            ...
            var res = await ApiHelper.ExecuteAsync<List<AuditModel>>("/audit/get-list-name", model, Method.GET, ApiHosts.Asset);
            var organizations = ApiHelper.Execute<List<SelectItem>>("/audit/get-organizationUnit", null, Method.GET, ApiHosts.Asset);
            var orders = res.data;
            var orders1 = organizations.data;

            ExcelPackage.LicenseContext = OfficeOpenXml.LicenseContext.NonCommercial;
            using var pck = new ExcelPackage();
            //Create the worksheet
            var ws = pck.Workbook.Worksheets.Add("Danh sách kiểm kê TS hành chính");
            ...
            if (orders != null)
                foreach (var order in orders)
                {
                    ...
                    ws.Cells[i, 4].Value = orders1.FirstOrDefault(x=>x.id.Equals(order.AuditLocation)).text;
        ...
        public async Task<ActionResult> GetExcelReport(AuditSearchModel model)
        {
            ...
            if (data?.Count > 0)
            {
                foreach (var e in data)
                {
                    var m = new AuditExportModel
                    {
                        ...
                        AssetType = "Tài sản hành chính",
                        Description = e.Description,
                        AuditLocation = orders1.FirstOrDefault(x => x.id.Equals(e.AuditLocation)).text,
            ...
            infoRow["Title"] = "Báo cáo kiểm kê tài sản hành chính";
            ...
            var tmpPath = CommonHelper.MapPath("/wwwroot/Teamplate/Excel/Audit_vi.xlsx");
            ...
            var fileDownloadName = "bao_cao_kiem_ke_tai_san_hanh_chinh.xlsx";
        ...
        public virtual async Task<IActionResult> ImportExcel(IEnumerable<AuditModel> models)
        {
            ...
            foreach (var item in models)
            {
                ...
                var check1 = (IEnumerable<SelectListItem>)ViewData["organization"];
                item.AuditLocation = GetReason(check1, item.AuditLocation.Trim());

                var teamCreate = new List<AuditModel>();
                teamCreate.Add(item);
                countColumn++;
                var res = await ApiHelper.ExecuteAsync("/audit/create", item, Method.POST, ApiHosts.Asset);
        ...
        {
            var fileName = "danh-sach-kiem-ke-hanh-chinh.xlsx";
            ExcelPackage.LicenseContext = OfficeOpenXml.LicenseContext.NonCommercial;
            using var pck = new ExcelPackage();
            //Create the worksheet
            var ws = pck.Workbook.Worksheets.Add("Danh sách kiểm kê TS hành chính");
        ...
        public async Task<byte[]> GetExcelReportError(Dictionary<int, string> model)
        {
            ...
            dtInfo.Columns.Add("Title", typeof(string));
            var infoRow = dtInfo.NewRow();
            infoRow["Title"] = "Danh sách nhập lỗi kiểm kê hành chính";
            dtInfo.Rows.Add(infoRow);
            ds.Tables.Add(dtInfo);
        ...
        {
            var res = ApiHelper.Execute<List<OrganizationModel>>("/organization/get-available", null, Method.GET, ApiHosts.Master);
            ...
            ViewData["organization"] = categories;
        ...
        public async Task<ActionResult> ExportDone(string? id)
        {
            ...
            var entity = res.data;
            var result = await ApiHelper.ExecuteAsync<List<AuditDetailModel>>($"/audit-detail/detail-get?AuditId={id}", null, Method.GET, ApiHosts.Asset);
            var result1 = await ApiHelper.ExecuteAsync<List<AuditCouncilModel>>($"/audit-council/get?AuditId={id}", null, Method.GET, ApiHosts.Asset);
            var organizations = ApiHelper.Execute<List<OrganizationModel>>("/organization/get-available", null, Method.GET, ApiHosts.Master);
            var orders1 = organizations.data;
            ...
            infoRow["AuditLocation"] = orders1.FirstOrDefault(x => x.Id.ToString().Equals(res.data?.AuditLocation)).Name;
