...
namespace VTQT.Web.Asset.Areas.Admin.Helper
{
    ...
    {
        public static byte[] FillReport(string filename, string templatefilename, DataSet data)
        {
            return FillReport(filename, templatefilename, data, new string[] { "%", "%" });
        }

        public static byte[] FillReport(string filename, string templatefilename, DataSet data, string[] deliminator)
        {
            ...
            using (var file = new FileStream(filename, FileMode.CreateNew))
            {
                using (var temp = new FileStream(templatefilename, FileMode.Open))
                {
                    ...
                    var xls = new ExcelPackage(file, temp);
