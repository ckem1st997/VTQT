...
namespace VTQT.Api.Asset.Controllers
{
    ...
    [XBaseApiAuthorize]
    [AppApiController("Asset.Controllers.AuditProject")]
    public class AuditProjectController : AdminApiController
    {
        #region Fields
        ...
        /// <summary>
        /// Lấy danh sách  kiểm kê tài dự án sản phân trang
        /// </summary>
        ...
        /// <summary>
        /// Lấy danh sách kiểm kê tài sản dự án phân trang hiển thị name join to table
        /// </summary>
        /// <param name="searchModel"></param>
        /// <returns></returns>
        /// <response code="200">Got successfully</response>
        ...
        [Route("index")]
        [HttpGet]
        [AppApiAction("Asset.AppActions.AuditProjects.Index")]
        ...
        /// <summary>
        /// Lấy chi tiết danh sách kiểm kê tài sản dự án
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        [Route("details")]
        [HttpGet]
        [AppApiAction("Asset.AppActions.AuditProjects.Details")]
        ...
        /// <summary>
        /// Tạo mới danh sách kiểm kê tài sản dự án
        /// </summary>
        /// <returns></returns>
        [Route("create")]
        [HttpGet]
        [AppApiAction("Asset.AppActions.AuditProjects.Create")]
        ...
        /// <summary>
        /// Thêm mới danh sách kiểm kê tài sản dự án
        /// </summary>
        ...
        /// <summary>
        /// Trả về danh sách kiểm kê tài sản dự án
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        [Route("edit")]
        [HttpGet]
        [AppApiAction("Asset.AppActions.AuditProjects.Edit")]
        ...
        /// <summary>
        /// Cập nhật danh sách kiểm kê tài sản dự án
        /// </summary>
        /// <param name="model"></param>
        /// <returns></returns>
        [Route("edit")]
        ...
        /// <summary>
        /// Xóa danh sách kiểm kê tài sản dự án theo danh sách
        /// </summary>
        /// <param name="ids"></param>
        /// <returns></returns>
        [Route("deletes")]
        [HttpPost]
        [AppApiAction("Asset.AppActions.AuditProjects.Deletes")]
