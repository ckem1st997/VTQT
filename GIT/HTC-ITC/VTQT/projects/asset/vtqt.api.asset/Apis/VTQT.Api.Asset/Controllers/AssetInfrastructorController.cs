...
{
    [Route("asset-infrastructor")]
    [ApiController]
    [XBaseApiAuthorize]
    [AppApiController("Asset.Controllers.AssetInfrastructor")]
    public class AssetInfrastructorController : AdminApiController
    {
        #region Fields
        ...
        #region Ctor
        public AssetInfrastructorController(
        ...
        [Route("index")]
        [HttpGet]
        [AppApiAction("Asset.AppActions.AssetInfrastructors.Index")]
        ...
        [Route("create")]
        [HttpPost]
        [AppApiAction("Asset.AppActions.AssetInfrastructors.Create")]
        ...
        {
            var model = new AssetInfrastructorModel
            {
        ...
        [Route("edit")]
        [HttpPost]
        [AppApiAction("Asset.AppActions.AssetInfrastructors.Edit")]
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            var model = entity.ToAssetInfrastructorModel();
        ...
        [Route("details")]
        [HttpGet]
        [AppApiAction("Asset.AppActions.AssetInfrastructors.Details")]
        ...
        [Route("deletes")]
        [HttpPost]
        [AppApiAction("Asset.AppActions.AssetInfrastructors.Deletes")]
        ...
        public async Task<IActionResult> Get([FromQuery] AssetSearchModel searchModel)
        {
            ...
            var models = new List<AssetInfrastructorModel>();
            var entities = _assetService.Get(searchContext);
            foreach (var e in entities)
            {
                var m = e.ToAssetInfrastructorModel();
                ...
                m.StationAddress = e.StationAddress;
                m.StationArea = e.StationArea;
                m.StationCategory = e.StationCategory;
                m.StationLatitude = e.StationLatitude;
                m.StationLongitude = e.StationLongitude;
                models.Add(m);
            }
