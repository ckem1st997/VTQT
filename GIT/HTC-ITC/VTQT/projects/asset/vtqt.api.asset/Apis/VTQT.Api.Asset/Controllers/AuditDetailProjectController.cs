...
{
    [Route("audit-detail-project")]
    [ApiController]
    [Produces("application/json")]
    [XBaseApiAuthorize]
    [AppApiController("Asset.Controllers.AuditDetailProject")]
    public class AuditDetailProjectController : AdminApiController
    {
        #region Fields
        ...
        public AuditDetailProjectController(
        ...
        [Route("index")]
        [HttpGet]
        [AppApiAction("Asset.AppActions.AuditDetailProjects.Index")]
        ...
        /// <summary>
        /// tạo mới chi tiết danh sách kiểm kê tài sản dự án
        /// </summary>
        ...
        /// <summary>
        /// Trả về chi tiết danh sách kiểm kê tài sản dự án
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        [Route("detail-edit")]
        ...
        /// <summary>
        /// Cập nhật chi tiết danh sách kiểm kê tài sản dự án
        /// </summary>
        /// <param name="model"></param>
        /// <returns></returns>
        [Route("detail-edit")]
        ...
        /// <summary>
        /// Xóa chi tiết danh sách kiểm kê tài sản dự án theo danh sách
        /// </summary>
        ...
        /// <summary>
        /// Lấy chi tiết danh sách kiểm kê tài sản dự án phân trang
        /// </summary>
        ...
        public async Task<IActionResult> DetailGet([FromQuery] AuditDetailSearchModel searchModel)
        {
            ...
            var assetItems = _assetService.GetAll((int)AssetType.Project);
