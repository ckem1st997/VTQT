...
{
    [Route("audit-infrastructor")]
    [ApiController]
    [Produces("application/json")]
    [XBaseApiAuthorize]
    [AppApiController("Asset.Controllers.AuditInfrastructor")]
    public class AuditInfrastructorController : AdminApiController
    {
        #region Fields
        ...
        public AuditInfrastructorController(
        ...
        #region List  
        /// <summary>
        /// Lấy danh sách  kiểm kê tài sản hạ tầng phân trang
        /// </summary>
        ...
        /// <summary>
        /// Lấy danh sách kiểm kê tài sản hạ tầng phân trang hiển thị name join to table
        /// </summary>
        /// <param name="searchModel"></param>
        /// <returns></returns>
        /// <response code="200">Got successfully</response>
        ...
        [Route("index")]
        [HttpGet]
        [AppApiAction("Asset.AppActions.AuditInfrastructors.Index")]
        ...
        /// <summary>
        /// Lấy chi tiết danh sách kiểm kê tài sản hạ tầng
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        [Route("details")]
        [HttpGet]
        [AppApiAction("Asset.AppActions.AuditInfrastructors.Details")]
        ...
        /// <summary>
        /// Tạo mới danh sách kiểm kê tài sản hạ tầng
        /// </summary>
        /// <returns></returns>
        [Route("create")]
        [HttpGet]
        [AppApiAction("Asset.AppActions.AuditInfrastructors.Create")]
        ...
        /// <summary>
        /// Trả về danh sách kiểm kê tài sản hạ tầng
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        [Route("edit")]
        [HttpGet]
        [AppApiAction("Asset.AppActions.AuditInfrastructors.Edit")]
        ...
        /// <summary>
        /// Cập nhật danh sách kiểm kê tài sản hạ tầng
        /// </summary>
        /// <param name="model"></param>
        /// <returns></returns>
        [Route("edit")]
        ...
        /// <summary>
        /// Xóa danh sách kiểm kê tài sản hạ tầng theo danh sách
        /// </summary>
        /// <param name="ids"></param>
        /// <returns></returns>
        [Route("deletes")]
        [HttpPost]
        [AppApiAction("Asset.AppActions.AuditInfrastructors.Deletes")]
