...
{
    [Route("audit-council-project")]
    [ApiController]
    [Produces("application/json")]
    [XBaseApiAuthorize]
    [AppApiController("Asset.Controllers.AuditCouncilProject")]
    public class AuditCouncilProjectController : AdminApiController
    {
        #region Fields
        ...
        public AuditCouncilProjectController(IAuditCouncilService auditCouncilService,
        ...
        [Route("index")]
        [HttpGet]
        [AppApiAction("Asset.AppActions.AuditCouncilProjects.Index")]
        ...
        /// <summary>
        /// lấy chi tiết danh sách hội đồng kiểm kê dự án
        /// </summary>
        /// <returns></returns>
        [Route("create")]
        [HttpGet]
        ...
        /// <summary>
        /// tạo mới chi tiết danh sách hội đồng kiểm kê dự án
        /// </summary>
        ...
        /// <summary>
        /// Trả về chi tiết danh sách hội đồng kiểm kê dự án
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        [Route("edit")]
        ...
        /// <summary>
        /// Cập nhật chi tiết danh sách hội đồng kiểm kê dự án
        /// </summary>
        /// <param name="model"></param>
        /// <returns></returns>
        [Route("edit")]
        ...
        /// <summary>
        /// Xóa chi tiết danh sách hội đồng kiểm kê dự án theo danh sách
        /// </summary>
        ...
        /// <summary>
        /// Lấy chi tiết danh sách hội đồng kiểm kê dự án phân trang
        /// </summary>
