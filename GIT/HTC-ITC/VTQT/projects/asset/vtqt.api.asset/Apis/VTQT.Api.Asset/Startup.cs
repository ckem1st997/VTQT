...
using VTQT.SharedMvc.Asset.Infrastructure.AutoMapperProfiles;
using VTQT.SharedMvc.Master.Infrastructure.AutoMapperProfiles;

namespace VTQT.Api.Asset
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddXBaseSwagger("v1", "VTQT Asset API", "VTQT.Api.Asset.xml");
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseXBaseSwagger("/swagger/v1/swagger.json", "VTQT Asset API");
        }
    }
}
