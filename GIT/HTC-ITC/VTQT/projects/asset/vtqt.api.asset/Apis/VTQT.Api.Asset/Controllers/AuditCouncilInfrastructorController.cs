...
{
    [Route("audit-council-infrastructor")]
    [ApiController]
    [Produces("application/json")]
    [XBaseApiAuthorize]
    [AppApiController("Asset.Controllers.AuditCouncilInfrastructor")]
    public class AuditCouncilInfrastructorController : AdminApiController
    {
        #region Fields
        ...
        public AuditCouncilInfrastructorController(IAuditCouncilService auditCouncilService,
        ...
        [Route("index")]
        [HttpGet]
        [AppApiAction("Asset.AppActions.AuditCouncilInfrastructors.Index")]
        ...
        /// <summary>
        /// lấy chi tiết danh sách hội đồng kiểm kê hạ tầng
        /// </summary>
        /// <returns></returns>
        [Route("create")]
        [HttpGet]
        ...
        /// <summary>
        /// tạo mới chi tiết danh sách hội đồng kiểm kê hạ tầng
        /// </summary>
        ...
        /// <summary>
        /// Trả về chi tiết danh sách hội đồng kiểm kê hạ tầng
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        [Route("edit")]
        ...
        /// <summary>
        /// Cập nhật chi tiết danh sách hội đồng kiểm kê hạ tầng
        /// </summary>
        /// <param name="model"></param>
        /// <returns></returns>
        [Route("edit")]
        ...
        /// <summary>
        /// Xóa chi tiết danh sách hội đồng kiểm kê hạ tầng theo danh sách
        /// </summary>
        ...
        /// <summary>
        /// Lấy chi tiết danh sách hội đồng kiểm kê hạ tầng phân trang
        /// </summary>
