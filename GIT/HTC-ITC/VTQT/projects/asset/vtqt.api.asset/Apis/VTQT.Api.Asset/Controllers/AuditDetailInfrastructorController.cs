...
{
    [Route("audit-detail-infrastructor")]
    [ApiController]
    [Produces("application/json")]
    [XBaseApiAuthorize]
    [AppApiController("Asset.Controllers.AuditDetailInfrastructor")]
    public class AuditDetailInfrastructorController : AdminApiController
    {
        #region Fields
        ...
        public AuditDetailInfrastructorController(
        ...
        [Route("index")]
        [HttpGet]
        [AppApiAction("Asset.AppActions.AuditDetailInfrastructors.Index")]
        ...
        /// <summary>
        /// tạo mới chi tiết danh sách kiểm kê tài sản hạ tầng
        /// </summary>
        ...
        /// <summary>
        /// Trả về chi tiết danh sách kiểm kê tài sản hạ tầng
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        [Route("detail-edit")]
        ...
        /// <summary>
        /// Cập nhật chi tiết danh sách kiểm kê tài sản hạ tầng
        /// </summary>
        /// <param name="model"></param>
        /// <returns></returns>
        [Route("detail-edit")]
        ...
        /// <summary>
        /// Xóa chi tiết danh sách kiểm kê tài sản hạ tầng theo danh sách
        /// </summary>
        ...
        public async Task<IActionResult> DetailGet([FromQuery] AuditDetailSearchModel searchModel)
        {
            ...
            var assetItems = _assetService.GetAll((int)AssetType.Infrastructure);
