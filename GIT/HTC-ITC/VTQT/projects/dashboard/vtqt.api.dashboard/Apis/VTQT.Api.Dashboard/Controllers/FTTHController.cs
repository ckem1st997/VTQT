...
namespace VTQT.Api.Dashboard.Controllers
{
    ...
    public class FTTHController : AdminApiController
    {

        #region Fields

        private readonly IFTTHService _service;
        ...
        public FTTHController(
            IFTTHService service,
        ...
        [HttpPost]
        // [AppApiAction("WareHouse.AppActions.Inwards.Create")]
        public async Task<IActionResult> Create(IEnumerable<FTTHModel> model)
        {
        ...
        public async Task<IActionResult> Edit(IEnumerable<FTTHModel> model)
        {
            if (model == null)
                return Ok(new XBaseResult
                {
        ...
        [HttpPost]
        //  [AppApiAction("WareHouse.AppActions.Inwards.Edit")]
        public async Task<IActionResult> Edit(FTTHAddOrUpdateModel model)
        {
            ...
            {
                var listEntityAdd = new List<FTTH>();
