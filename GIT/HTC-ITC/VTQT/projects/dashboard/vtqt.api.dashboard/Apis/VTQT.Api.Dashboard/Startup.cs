...
namespace VTQT.Api.Dashboard
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddXBaseSwagger("v1", "VTQT Dashboard API", "VTQT.Api.Dashboard.xml");
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseXBaseSwagger("/swagger/v1/swagger.json", "VTQT Dashboard API");
        }
    }
}
