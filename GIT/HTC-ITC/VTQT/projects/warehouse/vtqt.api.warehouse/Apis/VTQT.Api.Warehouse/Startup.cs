...
namespace VTQT.Api.Warehouse
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddXBaseSwagger("v1", "VTQT Warehouse API", "VTQT.Api.Warehouse.xml");
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseXBaseSwagger("/swagger/v1/swagger.json", "VTQT Warehouse API");
        }
    }
}
