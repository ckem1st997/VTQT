...
namespace VTQT.Api.Warehouse.Controllers
{
    ...
    [ApiController]
    [XBaseApiAuthorize]
    [AppApiController("WareHouse.Controllers.Category")]
    public class CategoryController : AdminApiController
    {
        #region Fields
        ...
        /*[Route("create-batch")]
        [HttpPost]
        public async Task<IActionResult> CreateBatch(IEnumerable<CategoryModel> models)
        {
            ...
            var countDone = await _categoryService.InsertWHAsync(entities);
            return Ok(new XBaseResult
            {
                success = true,
                data = countDone,
...
*/
        [Route("index")]
        [HttpGet]
        [AppApiAction("WareHouse.AppActions.Categorys.Index")]
        ...
        [Route("details")]
        [HttpGet]
        [AppApiAction("WareHouse.AppActions.Categorys.Details")]
        public async Task<IActionResult> Details(string id)
        {
            ...
            if (entity == null)
                ...
                {
                    success = false,
                    message = string.Format(T("Common.Notify.DoesNotExist"), T("Common.Category"))
                });
        ...
        public async Task<IActionResult> Create(WareHouseModel model)
        {
            ...
            if (await _categoryService.ExistsAsync(model.Code))
                return Ok(new XBaseResult
                {
                    success = false,
...
*/
       ...
       /*[AppApiAction("WareHouse.AppActions.WareHouses.Edit")]*/
        ...
        public async Task<IActionResult> Edit(WareHouseModel model)
        {
            ...
            var entity = await _categoryService.GetByIdAsync(model.Id);
            if (entity == null)
                return Ok(new XBaseResult
                {
                    success = false,
           ...
           // entity = model.ToEntity(entity);
            ...
            //_categoryService.UpdatePath(entity);
            // Locales
            //await UpdateLocalesAsync(entity, model);

            return Ok(new XBaseResult
            {
                message = string.Format(T("Common.Notify.Updated"), T("Common.Category"))
            });
        }
        ...
        public async Task<IActionResult> Activates(ActivatesModel model)
        {
            ...
            await _categoryService.ActivatesAsync(model.Ids, model.Active);
        ...
        public async Task<IActionResult> Get([FromQuery] WareHouseSearchModel searchModel)
        {
            ...
            var entities = _categoryService.Get(searchContext);
        ...
        {
            var availableList = _categoryService.GetAll(showHidden);
    ...
    Dictionary<string, IEnumerable<string>> errors)
        {
            ...
            var existCodes = await _categoryService.ExistCodesAsync(lstCodes);
